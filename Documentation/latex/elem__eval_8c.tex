...
Functions that evaluate discretization of variational formulation \+: A\+\_\+\+K\+\_\+ij and l\+\_\+\+K\+\_\+i for the element K.  
...
\begin{DoxyCompactList}\small\item\em Return the quadrature order corresponding to the element type. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Give the local number of the nodes at each side of the edge (we suppose we approximate the element geometry at the order 1) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em select n\+\_\+pts in the coord\+Set and copy them into sel\+\_\+coord \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Compute the contribution of the quadrature points x\+\_\+k for the integral\textquotesingle{}s quadrature of the shape g(x\+\_\+k)w\+\_\+i(x\+\_\+k) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Compute quadrature contribution of the quadrature point x for each base function w\+\_\+i for the integral of the shape w\+\_\+i\texorpdfstring{$\ast$}{*}g. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Evaluates the integrals on the element K with quadrature formula \texorpdfstring{$\ast$}{*}/. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Evaluates the integrals on the edges of element K (K prime) with quadrature formula. \end{DoxyCompactList}\item 
...
Evaluates the integrals on the element K with quadrature formula \texorpdfstring{$\ast$}{*}/. 

Evaluates the integrals on the element K with quadrature formula. \Hypertarget{elem__eval_8c_afed67963460022130e36abecf3a43933}\index{elem\_eval.c@{elem\_eval.c}!inv\_2x2@{inv\_2x2}}
...
Compute quadrature contribution of the quadrature point x for each base function w\+\_\+i for the integral of the shape sum (alpha,beta = 1 -\/\texorpdfstring{$>$}{>} 2) g\+\_\+\{alpha,beta\}(x)\texorpdfstring{$\ast$}{*}d\+\_\+alpha(w\+\_\+i)\texorpdfstring{$\ast$}{*}d\+\_\+beta(w\+\_\+j) \Hypertarget{elem__eval_8c_a5f2fabf585679a00a5f90d4814ac257c}\index{elem\_eval.c@{elem\_eval.c}!q\_contrib\_gW@{q\_contrib\_gW}}
...
Compute the contribution of the quadrature points x\+\_\+k for the integral\textquotesingle{}s quadrature of the shape g(x\+\_\+k)w\+\_\+i(x\+\_\+k) 

Compute the contribution of the quadrature points x\+\_\+k for the integral\textquotesingle{}s quadrature of the shape g(x\+\_\+k)w\+\_\+i(x\+\_\+k) for i in \mbox{[}1,n\+\_\+node\+\_\+elem\mbox{]}. \Hypertarget{elem__eval_8c_a8f1685423e8601a5cae4fb560f4dd9ee}\index{elem\_eval.c@{elem\_eval.c}!q\_contrib\_gWW@{q\_contrib\_gWW}}
...
Returns the quadrature order corresponding to the element type. \Hypertarget{elem__eval_8c_aab25700c4cb50662e141408f6b85a663}\index{elem\_eval.c@{elem\_eval.c}!selectPts@{selectPts}}
...
select n\+\_\+pts in the coord\+Set and copy them into sel\+\_\+coord 

Select n\+\_\+pts in the coord\+Set and copy them into select\+\_\+coord. \Hypertarget{elem__eval_8c_ab87ad12377de19e865ea3c74b61ca111}\index{elem\_eval.c@{elem\_eval.c}!transFK@{transFK}}
...
Give the local number of the nodes at each side of the edge. \Hypertarget{elem__eval_8c_a8899171f0ec171b870816d8dcd38d7d5}\index{elem\_eval.c@{elem\_eval.c}!wp\_quad@{wp\_quad}}
